 ...
 * Walkaway handler.
 *
 * Depressurizes the system if a visitor is determined to have "walked away"
 * after pressurizing the system but not firing the rocket, and periodically to
 * release pressure due to changes in room temperature while waiting for the next
 * visitor.
 *
 * On start stores the current pressure as the room pressure.
 *
 * Provides a "depressurize check" method to be run periodically between button
 * presses.  If the pressure
 *
 * System Normal:
